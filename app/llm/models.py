...
class LLMRequirementDecision(BaseModel):
    ...
    def validate_grounding(self):
        ...
        if self.status == "missing" and (self.evidence_ids or self.partial_evidence_ids):
            raise ValueError("A missing requirement cannot cite supporting or partial evidence")
