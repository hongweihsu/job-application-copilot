...
Prompt: `requirement-match-v5-composite-requirements`
...
| v2-dev-ml-kubernetes-operations | partial | partial | — | resume-s8 | resume-s3, resume-s4, resume-s11, resume-s12 | — |
| v2-dev-delivery-cloud-migration | partial | missing | — | — | resume-s3, resume-s10, resume-s2, resume-s8 | resume-s4 |
| v2-dev-mobile-react-native | missing | missing | — | — | resume-s2, resume-s1, resume-s12, resume-s11 | resume-s5 |
...
- Missing safety control correct: True

## API usage

- LLM: 5 requests, 4114 input tokens, 5570 output tokens
...
Cloud migration remains an annotation-sensitive failure after two prompt revisions. Further single-case prompt tuning is stopped to avoid overfitting; the case requires adjudication or more examples with the same composite-requirement pattern.
